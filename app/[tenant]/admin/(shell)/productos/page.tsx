              ...
              <tr key={product.id} className="border-b border-border last:border-0">
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center justify-end gap-3">
                    <Link href={`/${tenantSlug}/admin/productos/${product.id}`} className="text-xs font-semibold uppercase text-accent-strong hover:underline">
                      Editar
                    </Link>
                    <NSAdminDeleteButton
                      action={deleteProductAction.bind(null, tenant.id, tenantSlug, product.id)}
