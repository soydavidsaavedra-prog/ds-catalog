...
export default async function AdminDashboardPage() {
  ...
  const stats = [
    { label: "Productos activos", value: products.filter((p) => p.active).length, href: "/admin/productos" },
    { label: "Sin stock", value: products.filter((p) => p.availability === "out_of_stock").length, href: "/admin/productos" },
    { label: "Categorías", value: categories.length, href: "/admin/categorias" },
    { label: "Pedidos nuevos", value: orders.filter((o) => o.status === "new").length, href: "/admin/pedidos" },
  ];
