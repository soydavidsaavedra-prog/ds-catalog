...
export function NSHeroSlideUploadForm({
  ...
  return (
    <section className="max-w-xl rounded-card border border-border bg-surface-elevated p-6">
      <h2 className="font-display text-lg uppercase tracking-wide">Agregar foto o video</h2>
      <p className="mt-1 text-sm text-muted-foreground">JPG, PNG, WEBP, AVIF (hasta 8MB) o MP4/WEBM (hasta 25MB).</p>
