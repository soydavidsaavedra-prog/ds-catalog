      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr] lg:px-8">
        <div>
          ...
          <div className="mt-5 flex gap-4">
            {settings.instagram ? (
              <a href={settings.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground hover:text-accent">
            ...
            {settings.facebook ? (
              <a href={settings.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-muted-foreground hover:text-accent">
                <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden>
            ...
            {settings.tiktok ? (
              <a href={settings.tiktok} target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-muted-foreground hover:text-accent">
                <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden>
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-widest text-foreground">Catálogo</p>
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-widest text-foreground">Beneficios</p>
          <ul className="mt-4 space-y-2.5 text-sm text-muted-foreground">
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-widest text-foreground">Contacto</p>
          <ul className="mt-4 space-y-2.5 text-sm text-muted-foreground">
