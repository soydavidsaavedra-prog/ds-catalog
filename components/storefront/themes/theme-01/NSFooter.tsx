...
export async function NSFooter({ tenantSlug }: { tenantSlug: string }) {
  ...
  return (
    <footer id="contacto" className="border-t border-ink-800 bg-ink-950 text-ink-200">
      ...
      <div className="flex flex-col items-center gap-2 border-t border-ink-800 px-4 py-6 text-center text-xs text-ink-500 sm:flex-row sm:justify-between sm:px-6 lg:px-8">
