...
import { NSStudioSelectable } from "@/lib/design-studio/selection-context";
...
export function Home({ tenantSlug, settings, categories, products, heroSlides, testimonials }: ThemeHomeProps) {
  ...
  return (
    <>
      <NSStudioSelectable id="hero" label="Portada">
        <NSHero
      ...
      <NSStudioSelectable id="story" label="Historia de fábrica">
        <NSFactoryStory
      ...
      <NSStudioSelectable id="collections" label="Categorías destacadas">
        <NSCollections
      ...
      <NSStudioSelectable id="testimonials" label="Testimonios">
